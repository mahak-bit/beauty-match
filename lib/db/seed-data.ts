// ---------------------------------------------------------------------------
// Development seed data — pure data, no side effects, no DB import.
//
...
//
// Split out from lib/db/seed.ts so tooling (e.g. a SQL-export script) can
// import the data without triggering the actual `seed()` DB write.
// ---------------------------------------------------------------------------
...
export const brandData: BrandSeed[] = [
...
export const MARKET_BY_SEGMENT: Record<BrandSeed["segment"], { currency: string; market: string; country: string[] }> = {
...
export const sample: ProductSeed[] = [
  // ---------------- Minimalist ----------------
  {
